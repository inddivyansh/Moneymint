...
export const CONTACT_US_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>New Contact Request</title>
</head>
<body style="font-family: sans-serif; background: #141414; color: #fff; padding: 40px;">
    <div style="background: #050505; border: 1px solid #30333A; padding: 30px; border-radius: 8px;">
        <h2 style="color: #FDD458;">New Support Request</h2>
        <p><strong>Name:</strong> {{name}}</p>
        <p><strong>Email:</strong> {{email}}</p>
        <div style="background: #212328; padding: 20px; border-radius: 8px; margin-top: 20px;">
